...
reactions_lumped_1 = [v_biomass, v_respiration, v_substrate_product]
reactions_lumped_1_sink = [v_biomass, v_respiration, v_substrate_product, v_sink_substrate]


reactions_lumped_2 = [v_biomass, v_respiration, v_substrate_dhap, v_dhap_product]
reactions_lumped_2_sink = [v_biomass, v_respiration, v_substrate_dhap, v_dhap_product, v_sink_substrate, v_sink_dhap]
...
def make_lumped_model(y0, parameters,reactions, output_dir, model_name):
    ...
    sbml.export(initial_conditions=y0,
                ...
                output_file=f"{output_dir}/{model_name}_balanced.xml")
...
make_lumped_model(y0_lumped_1, parameters_original,reactions_lumped_1_sink, output_dir, "pCA_model_lumped_1_part_1_sink")
make_lumped_model(y0_lumped_2, parameters_original,reactions_lumped_2_sink, output_dir, "pCA_model_lumped_2_part_1_sink")


# Question 3 part 2

reactions_lumped_1_part_2 = [v_substrate_product_no_co2]
reactions_lumped_1_part_2_sink = [v_substrate_product_no_co2, v_sink_substrate_no_biomass]
...
make_lumped_model(y0_lumped_1_part_2, parameters_original, reactions_lumped_1_part_2_sink, output_dir, "pCA_model_lumped_1_part_2_sink")
