...
def main():
    ...
    def run_tuning_individual_parameter(parameter_name: str, batch_sizes, train_size, total_size):
        ...
        OUTPUT_DIR = f"Experiments/Parameter_tuning/batch_size_vs_width/{parameter_name}"
    ...
    run_tuning_individual_parameter("500_strains", [16, 32, 64, 128, 192, 256, 300, 500], train_size=500, total_size=650)
    run_tuning_individual_parameter("200_strains", [8, 16, 32, 64, 128, 200], train_size=200, total_size=350)
    run_tuning_individual_parameter("50_strains", [4, 8, 16, 32, 50], train_size=50, total_size=200)
    run_tuning_individual_parameter("24_strains", [4, 8, 16, 24], train_size=24, total_size=399)
