...
parameters_lumped_1 = {
    ...
    "vmax_respiration": 0.35,
    "km_respiration_A": 0.03,
    "vmax_substrate_product": 0.1,
    "km_substrate_product": 0.02,
}
...
parameters_lumped_2 = {
    ...
    "vmax_respiration": 0.35,
    "km_respiration_A": 0.03,
    "vmax_substrate_dhap": 0.1,
    "km_substrate_dhap": 0.02,
    "vmax_dhap_product": 0.1,
    "km_dhap_product": 0.02,
}
...
parameters_lumped_3 = {
    ...
    "km_sink2_pep": 0.02,
    "km_sink1_e4p": 0.02,
    "km_shiki_2_product_pep": 0.02,
    "km_shiki_2_product_dhap": 0.02,
    "vmax_shiki_2_product": 0.1,
}

reactions_lumped_3 = [v_biomass, v_respiration, v_ppp, v_glyc, v_shiki_step1, v_shiki_2_product, v_sink1, v_sink2]
...
reactions_lumped_3_part_2 = [v_biomass, v_respiration, v_ppp, v_glyc, v_shiki_step1, v_shiki_2_product]

reactions_lumped_2_part_2 = [v_biomass, v_respiration, v_ppp, v_glyc, v_shiki_1_product]
